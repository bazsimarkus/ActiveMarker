...
{
    public class SymbolListTwoSymbolWithError : SymbolListBase
    {
        //paraméterek
        int symbolNumber = 2;
        ...
        public SymbolListTwoSymbolWithError(CarID id)
        {
            int IdToCode = id.ID;
            ...
            {
                Symbols.Add(new SymbolOneWithError() { ID = GetBit(IdToCode, i) });
