...
{
    public class SimulationSetupBasicTwo:SimulationSetupBase
    {
        public SimulationSetupBasicTwo() {
        ...
        public override void SimulationStart() {
            ...
            Engine.E.PathList[0].CreatePath(150, 1, 0, 0,0);
            Engine.E.PathList[1].CreatePath(300, 1, 0, 0, 0);
            ...
            Car Car2 = new Car(new CarID(805), Engine.E.PathList[1].Nodes[0], new Flasher(new SymbolListTwoSymbol(new CarID(805))), new VelocityControllerConst(0.01));
