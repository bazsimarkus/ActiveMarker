...
{
    public class SimulationSetupApproach4:SimulationSetupBase
    {
        public SimulationSetupApproach4() {
        ...
        public override void SimulationStart() {
            ...
            Car Car4 = new Car(new CarID(805), Engine.E.PathList[3].Nodes[0], new Flasher(new SymbolListTwoSymbol(new CarID(805))), new VelocityControllerConst(0.0025));
