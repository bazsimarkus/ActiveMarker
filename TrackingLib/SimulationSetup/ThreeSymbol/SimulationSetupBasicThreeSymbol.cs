...
{
    public class SimulationSetupBasicThreeSymbol:SimulationSetupBase
    {
        public SimulationSetupBasicThreeSymbol() {
        ...
        public override void SimulationStart() {
            ...
            Car Car1 = new Car(new CarID(34054), Engine.E.PathList[0].Nodes[0], new Flasher(new SymbolListThreeSymbol(symbolsToFlash)), new VelocityControllerConst(0.01));
